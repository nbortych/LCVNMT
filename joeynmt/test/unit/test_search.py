...
class TestSearchRecurrent(TestSearch):
    ...
    def test_recurrent_greedy(self):
        ...
        output, attention_scores = recurrent_greedy(src_mask=src_mask, max_output_length=max_output_length, model=model,
                                                    encoder_output=encoder_output, encoder_hidden=encoder_hidden)
    ...
    def test_recurrent_beam1(self):
        ...
        greedy_output, _ = recurrent_greedy(src_mask=src_mask, max_output_length=max_output_length, model=model,
                                            encoder_output=encoder_output, encoder_hidden=encoder_hidden)
